...
class CaregiverChatScreen extends StatefulWidget {
  ...
  const CaregiverChatScreen({super.key, required this.requestId});
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: mine ? CaregiverTheme.primary.withOpacity(0.12) : Colors.grey.shade200,
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, reqSnap) {
        if (reqSnap.hasError) {
          return Scaffold(body: Center(child: Text('Error: ${reqSnap.error}')));
        }
        if (!reqSnap.hasData) {
